...
def logistReg(x_t,y_t,test_x, test_y):
    model = Sequential()
    model.add(Dense(50,activation = 'sigmoid',kernel_regularizer = L1L2(l1=0,l2=0.1),input_dim = 1))
    model.add(Dense(64,activation = 'sigmoid',use_bias = False,bias_initializer = 'zeros', kernel_regularizer = L1L2(l1=0,l2=0.1),input_dim = 50))    
